...
int main(int argc, char ** argv)
{
    ...
    ROS_INFO("Marker Detector Node started");
    ...
    if(argc < 7){
        ...
        max_track_error = 0.2;
        cam_image_topic = "/softkinetic_camera/rgb/image_color";
        cam_info_topic = "/softkinetic_camera/rgb/camera_info";
        //        output_frame = "/softkinetic_camera_rgb_optical_frame";
    ...
    arMarkerPub_ = n.advertise < ar_track_alvar_msgs::AlvarMarkers > ("/marker_detector/pose", 0);
    rvizMarkerPub_ = n.advertise < visualization_msgs::Marker > ("/marker_detector/visualization_marker", 0);
    ...
    if (enabled == true)
    {
        ...
        image_pub_ = it_.advertise("/marker_detector/output_image", 1);
    }
